...
• چت روزانه: +۵ سکه`,
  ...
  connectionsEmpty: '💬 هنوز اتصال دوطرفه‌ای ندارید.\nوقتی در یک چت هر دو طرف همدیگر را لایک کنید، اینجا می‌آید و می‌توانید پیام بفرستید.',
  directModeOn: (name: string) =>
    `✉️ حالت پیام مستقیم با ${name}\n\nهر چیزی بنویسید برای ایشان فرستاده می‌شود.\nبرای خروج «🔙 پایان پیام» را بزنید.`,
  directModeOff: '🔙 از حالت پیام مستقیم خارج شدید.',
  directSent: (name: string) => `✉️ برای ${name} فرستاده شد.`,
  directReplyHint: 'برای پاسخ، دکمهٔ زیر را بزنید.',
